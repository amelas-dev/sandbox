...
export default function App() {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-slate-100 via-white to-slate-100/60 pb-10 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950", children: _jsxs("div", { className: "mx-auto flex min-h-screen w-full max-w-screen-2xl flex-col gap-6 px-4 pt-6 sm:px-6 lg:gap-8", children: [_jsx(AppHeader, {}), _jsxs(DndContext, { sensors: sensors, onDragStart: handleDragStart, onDragEnd: handleDragEnd, onDragCancel: handleDragCancel, children: [_jsxs("div", { className: "grid flex-1 grid-cols-1 items-start gap-4 lg:[grid-template-columns:minmax(0,280px)_minmax(0,1fr)] xl:[grid-template-columns:minmax(0,280px)_minmax(0,1fr)_minmax(0,320px)]", children: [_jsxs("aside", { className: "order-1 flex min-h-[220px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/80 lg:sticky lg:top-24 lg:max-h-[calc(100vh-10rem)]", children: [_jsxs("div", { className: "mb-4 flex flex-wrap items-center justify-between gap-2", children: [_jsx("h2", { className: "text-sm font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400", children: "Field palette" }), dataset && _jsxs(Badge, { variant: "outline", children: [dataset.fields.length, " fields"] })] }), _jsx(FieldPalette, { onInsertField: handleInsertField })] }), _jsxs("main", { className: "order-2 flex min-h-[420px] min-w-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white/95 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/80 lg:min-h-[560px]", children: [_jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 px-4 py-3 text-xs uppercase tracking-wide text-slate-400 dark:border-slate-800 dark:text-slate-500 sm:px-6", children: [_jsx("span", { children: "Document designer" }), _jsxs("span", { className: "flex items-center gap-1 whitespace-nowrap", children: [_jsxs("span", { children: ["Page ", template.page.size] }), _jsx("span", { "aria-hidden": "true", children: "\u2022" }), _jsx("span", { className: "capitalize", children: template.page.orientation })] })] }), _jsx("div", { className: "flex-1", children: _jsx(DocumentDesigner, { droppableId: DROPPABLE_ID, onEditorReady: handleEditorReady, className: "h-full" }) })] }), _jsxs("aside", { className: "order-3 flex min-h-[220px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/80 lg:col-span-2 lg:flex-row lg:gap-6 lg:py-6 xl:col-span-1 xl:flex-col xl:gap-0 xl:py-4", children: [_jsx("div", { className: "mb-4 text-sm font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400 lg:mb-0 lg:w-40 xl:mb-4 xl:w-full", children: "Properties" }), _jsx("div", { className: "flex-1", children: _jsx(PropertiesPanel, {}) })] })] }), _jsx(DragOverlay, { dropAnimation: null, children: draggedField ? (_jsxs("div", { className: "flex items-center gap-2 rounded-xl border border-brand-200 bg-brand-50 px-3 py-2 text-sm font-medium text-brand-700 shadow-lg", children: [_jsx("span", { children: draggedField.label }), _jsx(Badge, { variant: "outline", children: `{{${draggedField.key}}}` })] })) : null })] }), _jsxs("footer", { className: "flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white/95 px-4 py-4 text-sm shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/85 md:flex-row md:items-center md:justify-between", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-x-6 gap-y-2 text-slate-600 dark:text-slate-300", children: [_jsxs("span", { children: ["Words: ", _jsx("strong", { children: stats.words })] }), _jsxs("span", { children: ["Characters: ", _jsx("strong", { children: stats.characters })] }), _jsxs("span", { children: ["Canvas: ", template.page.size, " \u2022 ", template.page.orientation] }), dataset && _jsxs("span", { children: [dataset.rows.length, " records"] })] }), _jsxs("div", { className: "flex flex-wrap items-center gap-4 text-slate-500 dark:text-slate-400", children: [autosaveEnabled ? (_jsxs("span", { children: [saveState === 'saving' ? 'Saving…' : 'All changes saved', saveState === 'saved' && lastSavedAt
