...
function FieldChip({ fieldKey, label, onInsert }) {
    ...
    return (_jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs("button", { ref: setNodeRef, type: "button", onDoubleClick: onInsert, className: cn('group flex w-full items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white px-3 py-2 text-left text-sm shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900', isDragging && 'border-brand-500 ring-2 ring-brand-500'), style: { transform: transform ? `translate3d(${transform.x}px, ${transform.y}px, 0)` : undefined }, ...listeners, ...attributes, children: [_jsxs("span", { className: "flex min-w-0 flex-1 items-center gap-2", children: [_jsx(GripVertical, { className: "h-4 w-4 shrink-0 text-slate-300 group-hover:text-brand-500" }), _jsx("span", { className: "min-w-0 break-words text-left font-medium text-slate-700 dark:text-slate-200", children: label })] }), _jsx(Badge, { variant: "outline", className: "shrink-0 whitespace-nowrap", children: `{{${fieldKey}}}` })] }) }), _jsxs(TooltipContent, { className: "max-w-xs", children: ["Sample value: ", value || '—'] })] }) }));
}
