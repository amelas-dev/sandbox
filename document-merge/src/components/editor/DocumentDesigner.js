...
export function DocumentDesigner({ className, onEditorReady, droppableId = 'designer-canvas' }) {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'min-h-[800px] prose prose-slate max-w-none focus:outline-none dark:prose-invert prose-headings:font-semibold',
            },
            handleDOMEvents: {
                keydown: (_view, event) => {
    ...
    return (_jsx("div", { ref: setNodeRef, className: cn('relative flex h-full w-full items-center justify-center overflow-auto bg-slate-100/70 p-4 sm:p-6', className), children: _jsxs("div", { className: cn('relative max-w-full rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-950'), style: {
            ...
            }, children: [showGrid && (_jsx("div", { className: "pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(99,102,241,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(99,102,241,0.08)_1px,transparent_1px)] [background-size:32px_32px]" })), _jsx("div", { className: "absolute inset-0 overflow-auto", children: _jsx("div", { style: { ...padding, ...baseStyles }, className: "relative h-full w-full", children: _jsx(EditorContent, { editor: editor }) }) }), _jsx("div", { className: "absolute inset-x-0 bottom-3 flex justify-center text-xs text-slate-400", children: _jsxs("span", { children: ["Zoom ", Math.round(zoom * 100), "% \u00B7 ", page.size, " ", page.orientation] }) })] }) }));
}
